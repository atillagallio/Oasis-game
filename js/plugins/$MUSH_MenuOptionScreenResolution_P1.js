...
/*:
* 
* @plugindesc [v.1.01] Adds the screen resolution option.
* @author MushroomCake28
* @help ***Must have the Menu Option Expansion script to work.***
*
...
Imported.mushFeatures['MenuOptionScreenResolution_P1'] = 1.01;

var $mushFeatures = $mushFeatures || { 'imported': {}, 'params': {} };
$mushFeatures.imported['MenuOptionScreenResolution_P1'] = 1.01;
...
var aliasMush_WindowOptionsChangeValueMoe = Window_Options.prototype.changeValueMoe;
Window_Options.prototype.changeValueMoe = function(symbol, operation, numValue) {
	aliasMush_WindowOptionsChangeValueMoe.call(this, symbol, operation, numValue);
	if (symbol == 'mosr_screenResolution') {
...
Window_Options.prototype.statusText = function(index) {
    ...
    if (this.isVolumeSymbol(symbol)) {
    	...
    	if (symbol == 'moe_textFont') {
    		...
    		return filename;
    	} else if (symbol == 'mosr_screenResolution') {
